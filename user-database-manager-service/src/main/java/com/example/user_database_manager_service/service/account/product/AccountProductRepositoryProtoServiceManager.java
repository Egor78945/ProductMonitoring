...
public class AccountProductRepositoryProtoServiceManager extends AccountProductRepositoryProtoService {
    public AccountProductRepositoryProtoServiceManager(AccountProductRepository<UserProtoConfiguration.AccountUuidProductUriMessage> accountProductRepository, CommonAccountService commonAccountService, CommonAccountProductService commonAccountProductService) {
