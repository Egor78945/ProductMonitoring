...
public class AccountProductRepositoryProtoTransactionalServiceManager extends AccountProductRepositoryProtoService{
    public AccountProductRepositoryProtoTransactionalServiceManager(AccountProductRepository<UserProtoConfiguration.AccountUuidProductUriMessage> accountProductRepository, CommonAccountService commonAccountService, CommonAccountProductService commonAccountProductService) {
