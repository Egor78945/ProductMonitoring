...
@Service
public class MarketplacePathServiceManager implements MarketplacePathService {
    private final MarketplacePathDefinitionRepository<MarketplacePathDefinition> marketplacePathDefinitionRepository;

    public MarketplacePathServiceManager(MarketplacePathDefinitionRepository<MarketplacePathDefinition> marketplacePathDefinitionRepository) {
    ...
    @Override
    public List<MarketplacePathDefinition> getSupportedMarketplaces() {
