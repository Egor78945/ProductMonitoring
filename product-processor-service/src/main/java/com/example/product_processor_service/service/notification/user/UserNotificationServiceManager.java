...
import com.example.product_processor_service.repository.notification.user.UserNotificationRepository;
...
public class UserNotificationServiceManager implements UserNotificationService<UserNotification> {
    ...
    public UserNotificationServiceManager(UserNotificationRepository userNotificationRepository) {
    ...
    public UserNotification findByUserUuidAndNotificationTypeId(UUID userUuid, Long notificationTypeId) {
        return userNotificationRepository.findByUserUuidAndNotificationTypeId(userUuid, notificationTypeId).orElseThrow(() -> new NotFoundException(String.format("user notification not found")));
    }
