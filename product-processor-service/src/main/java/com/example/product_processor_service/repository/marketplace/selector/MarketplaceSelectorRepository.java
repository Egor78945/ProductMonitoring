...
public abstract class MarketplaceSelectorRepository extends JooqRepository<MarketplaceSelector> {
    ...
    @Override
    public void saveAll(List<MarketplaceSelector> marketplaceSelectorList) {
        for (MarketplaceSelector ms : marketplaceSelectorList) {
            save(ms);
        }
    }
}
