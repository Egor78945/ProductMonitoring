...
public class UserProtoOnEmailLoginServiceManager extends UserProtoOnEmailLoginService<UserAuthenticationModel> {
    public UserProtoOnEmailLoginServiceManager(JwtService jwtService, UserService<UserProtoConfiguration.UserMessage> userService, AccountService<UserProtoConfiguration.AccountMessage> accountService, KeycloakLoginService<UserAuthenticationModel> keycloakLoginService) {
