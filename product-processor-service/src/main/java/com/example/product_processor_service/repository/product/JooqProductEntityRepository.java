...
public abstract class JooqProductEntityRepository extends JooqProductRepository<Product> {
    public JooqProductEntityRepository(DSLContext dslContext) {
        super(dslContext);
    }
    ...
    @Override
    public List<Product> findAllExpired(int limit, DatePart datePart, int count) {
        return dslContext
                .selectFrom(Tables.PRODUCT)
    ...
    @Override
    public List<Product> findAllByAccountUuid(UUID uuid, int page, int pageSize) {
        return dslContext
    ...
    @Override
    public Optional<Product> findByAccountUuidAndProductUrl(UUID accountUuid, String productUrl) {
        return dslContext
