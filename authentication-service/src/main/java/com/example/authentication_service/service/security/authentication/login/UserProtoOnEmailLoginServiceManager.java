...
@Service
public class UserProtoOnEmailLoginServiceManager extends UserProtoOnEmailLoginService<UserAuthenticationModel> {
    protected UserProtoOnEmailLoginServiceManager(JwtService jwtService, UserService<UserProtoConfiguration.UserMessage> userService, AccountService<UserProtoConfiguration.AccountMessage> accountService, KeycloakAuthenticationService<String, KeycloakRegistrationModel> keycloakAuthenticationService) {
