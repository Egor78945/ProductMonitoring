...
public abstract class JooqProductProtoRepository extends JooqProductRepository<ProductServiceProtoConfiguration.ProductMessage> {
    ...
    public ProductServiceProtoConfiguration.ProductMessage save(ProductServiceProtoConfiguration.ProductMessage product) {
        return dslContext
                ...
                .returning()
                .fetchOne(ProductProtoMapper::mapTo);
    }
    ...
    @Override
    public Optional<ProductServiceProtoConfiguration.ProductMessage> findByUrl(String productUrl) {
        return dslContext
    ...
    @Override
    public Optional<ProductServiceProtoConfiguration.ProductMessage> findByAccountUuidAndProductUrl(UUID accountUuid, String productUrl) {
        return dslContext
    ...
    @Override
    public List<ProductServiceProtoConfiguration.ProductMessage> findAllExpired(int timeLimit, DatePart datePart, int count) {
        return dslContext
                .selectFrom(Tables.PRODUCT)
    ...
    @Override
    public List<ProductServiceProtoConfiguration.ProductMessage> findAllByAccountUuid(UUID uuid, int page, int pageSize) {
        return dslContext
